        ...
        <Row id="dashboard" className="d-flex justify-content-center align-items-center">
          <Col xs="auto" sm="auto" md="auto" lg="auto">
            <div id="dashboard-card" className="d-flex justify-content-around">
              <Button id="join-room-button" variant="dark" onClick={handleShow}>Join Room</Button>
              <Button id="create-room-button" variant="dark" className="ms-4" onClick={createRoom}>Create Room</Button>
            </div>
          </Col>
        </Row>
      </Container>
